...
class AnimationKeyList
{
  ...
  public:
     ...
     * animation.
     */
    anim_prec_t get_frame_time(const size_t keyIndex) const noexcept;
     ...
     */
    void set_frame(const size_t frameIndex, const anim_prec_t frameTime, const data_t& frameData) noexcept;
...
-------------------------------------*/
template <typename data_t>
inline size_t AnimationKeyList<data_t>::size() const noexcept
{
    return numFrames;
}
...
-------------------------------------*/
template <typename data_t>
bool AnimationKeyList<data_t>::init(const size_t keyCount) noexcept
{
    if (!keyCount)
    {
        if (numFrames)
...
-------------------------------------*/
template <typename data_t>
inline anim_prec_t AnimationKeyList<data_t>::get_frame_time(const size_t keyIndex) const noexcept
{
...
-------------------------------------*/
template <typename data_t>
inline const data_t& AnimationKeyList<data_t>::get_frame_data(const size_t keyIndex) const noexcept
{
    LS_DEBUG_ASSERT(keyIndex < numFrames);
...
-------------------------------------*/
template <typename data_t>
inline data_t& AnimationKeyList<data_t>::get_frame_data(const size_t keyIndex) noexcept
{
    LS_DEBUG_ASSERT(keyIndex < numFrames);
    return keyData[keyIndex];
}
