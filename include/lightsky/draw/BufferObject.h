...
class BufferObject {
    protected:
        ...
        /**
         * @brief Helper function to copy attributes from one Buffer Object to
         * another.
         * 
         * @param from
    ...
    public:
         ...
         * 
         * Deleted as inherited classes are supposed to provide their usage to
        ...
        /**
         * @brief Buffer initialization & allocation.
         * 
         * Generates a vertex buffer object on the GPU that will be used to
         * contain a large pool of data. If successful in initialization, the
         * buffer's data will be preallocated to a specified size.
         * 
         * @param usage
         * Indicates the intended usage of the buffer object being initialized.
         * This parameter can impact context-sensitive GL functionality such as
         ...
         */
        inline ptrdiff_t get_size() const noexcept {
            GLint numBytes = 0;
         ...
         */
        inline buffer_access_t get_usage() const noexcept {
            unsigned usage = 0;
         ...
         */
        inline bool unmap_data() const noexcept {
