...
constexpr math::vec4_t<int_t> color_float_to_int(const math::vec4_t<float_t>& c) {
    return math::vec4_t<int_t>{
        eds::math::ranged_floor<float_t, int_t, range>((c[0] * range) + float_t {0.5}),
        eds::math::ranged_floor<float_t, int_t, range>((c[1] * range) + float_t {0.5}),
        eds::math::ranged_floor<float_t, int_t, range>((c[2] * range) + float_t {0.5}),
        eds::math::ranged_floor<float_t, int_t, range>((c[3] * range) + float_t {0.5})
    };
}
